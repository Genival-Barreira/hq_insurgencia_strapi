...
export interface ApiVisitanteVisitante extends Struct.CollectionTypeSchema {
  collectionName: 'visitantes';
  info: {
    displayName: 'visitante';
    pluralName: 'visitantes';
    singularName: 'visitante';
  };
  options: {
    draftAndPublish: true;
  };
